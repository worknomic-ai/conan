...
class LockfileAPI:
    ...
    @staticmethod
    def remove_lockfile(lockfile=None, requires=None, build_requires=None, python_requires=None):
        if lockfile is None:
            raise ConanException("A lockfile is required to remove requirements")
