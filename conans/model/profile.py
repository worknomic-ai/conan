...
class Profile(object):
    ...
    def serialize(self):
        ...
        return {
            ...
            "tool_requires": {k: [str(r) for r in v] for k, v in self.tool_requires.items()},
            "replace_requires": {k: [str(r) for r in v] for k, v in self.replace_requires.items()},
            "replace_tool_requires": {k: [str(r) for r in v] for k, v in self.replace_tool_requires.items()},
            "platform_requires": [str(r) for r in self.platform_requires],
            "platform_tool_requires": [str(r) for r in self.platform_tool_requires],
