...
BUILT_IN_CONFS = {
    ...
    "core:warnings_as_errors": "List of warnings that will be raised as errors",
    ...
    "tools.cmake:ctest_program": "Path to CTest executable",
    ...
    "tools.microsoft:winsdk_version": "Specifies the version of the Windows SDK to use.",
